    ...
    public IEnumerator Move(Rigidbody2D rigidBodyToMove, float speed)
    {
        ...
        while (remainingDistance > float.Epsilon)
        {
            ...
            if (rigidBodyToMove != null)
            {
                ...
                // mit Vector 2 klappt es vielleicht hab es irgend einen bug mit Vector3.MoveTowards, den ich nicht verstehe... 
                Vector2 newPosition = Vector2.MoveTowards(rigidBodyToMove.position, endPosition, speed * Time.deltaTime);
                rb2d.MovePosition(newPosition);

                // direction ist wenn das ziel weiter weg ist größer als wenn das ziel näher dran ist.... also ist der enemy am anfang schneller (how to fix??) 
                // Vector3 direction = (Vector2)endPosition - rigidBodyToMove.position;
